...
const PartiesPage = ({ language }) => {
  ...
  const handleRemove = async (id) => {
    ...
    try {
      ...
      await readJsonResponse(response, "Unable to delete activity");
  ...
  return (
    <div className="activity-page" dir={isArabic ? "rtl" : "ltr"} style={{ textAlign: isArabic ? "right" : "left" }}>
      <div className="activity-header">
        <div>
          <span className="activity-title-badge">{content.fetes || "Parties"}</span>
              ...
              {canManageActivities && (
                <div className="activity-item-actions">
                  <button
                    ...
                    title={content.activity_edit_button || "Edit"}
                  >
                    ✏️
                  </button>
                  {deleteConfirm === activity.id ? (
                    ...
                    <button
                      ...
                      title={content.activity_remove_button || "Remove"}
                    >
                      🗑
                    </button>
                  )}
