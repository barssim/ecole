...
class PaymentNoticeServiceTest {
    ...
    void testGetAllNotices() {
        ...
        when(paymentNoticeRepository.findBySchoolId("school-a")).thenReturn(notices);
        ...
        verify(paymentNoticeRepository, times(1)).findBySchoolId("school-a");
    }

    @Test
    void testGetNoticeById() {
        // Arrange
        when(paymentNoticeRepository.findByIdAndSchoolId(1, "school-a")).thenReturn(Optional.of(mockNotice));
        ...
        verify(paymentNoticeRepository, times(1)).findByIdAndSchoolId(1, "school-a");
    }

    @Test
    void testGetNoticeByIdNotFound() {
        // Arrange
        when(paymentNoticeRepository.findByIdAndSchoolId(999, "school-a")).thenReturn(Optional.empty());
    ...
    void testGetNoticesByStudent() {
        // Arrange
        List<PaymentNotice> notices = Arrays.asList(mockNotice);
        when(paymentNoticeRepository.findBySchoolIdAndStudentName("school-a", "John Doe")).thenReturn(notices);
        ...
        verify(paymentNoticeRepository, times(1)).findBySchoolIdAndStudentName("school-a", "John Doe");
    }

    @Test
    void testCreateNoticeSuccess() {
        // Arrange
        when(paymentNoticeRepository.findBySchoolId("school-a")).thenReturn(Arrays.asList());
    ...
    void testGetNoticesByStatus() {
        // Arrange
        List<PaymentNotice> notices = Arrays.asList(mockNotice);
        when(paymentNoticeRepository.findBySchoolIdAndStatus("school-a", "pending")).thenReturn(notices);
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        verify(paymentNoticeRepository, times(1)).findBySchoolIdAndStatus("school-a", "pending");
    }
}
