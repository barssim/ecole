...
class PaymentServiceTest {
    ...
    void setUp() {
        ...
        mockPayment.setSchoolId("school-a");
        mockPayment.setId(1);
    ...
    void testGetPaymentsByStudent() {
        ...
        when(paymentRepository.findBySchoolIdAndStudentName("school-a", "John Doe")).thenReturn(payments);
        ...
        verify(paymentRepository, times(1)).findBySchoolIdAndStudentName("school-a", "John Doe");
    }
    ...
    void testGetPaymentById() {
        // Arrange
        when(paymentRepository.findByIdAndSchoolId(1, "school-a")).thenReturn(Optional.of(mockPayment));
        ...
        assertNotNull(result);
        assertEquals("John Doe", result.getStudentName());
        verify(paymentRepository, times(1)).findByIdAndSchoolId(1, "school-a");
    }

    @Test
    void testGetPaymentByIdNotFound() {
        // Arrange
        when(paymentRepository.findByIdAndSchoolId(999, "school-a")).thenReturn(Optional.empty());
